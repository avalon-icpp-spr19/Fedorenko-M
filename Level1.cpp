...
int main() {
	...
	cout << "Совпали хотя бы два дня рождения в " << overallSuccsess << " симуляциях. Процент успешных: " << (static_cast<double>(overallSuccsess) / static_cast<double>(numOfSimulations)) * 100 << "%" << endl;
}
